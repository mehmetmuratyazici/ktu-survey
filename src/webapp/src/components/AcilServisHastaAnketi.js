...
const initialState = {
    ...
    rdbPersoneleKolayUlasim:"",
    rdbSunmusOlduguHimetler:"",
    rdbPersonelDavranis:"",
    rdbHastaneTemizlik:"",
    rdbBeklemeAlanKosul:"",
...
export default function AcilServisHastaAnketi() {
    ...
    async function sendRequestFrm(sendObj){
        const response = await axios.post('/ktusurvey/ktu/survey/acil', sendObj);
        /*
        ...
        <div className="App">
            ...
            <Container style={{}}>
                    <Form className="mb-3" >
                        ...
                        <Row>
                        <Form.Label>ACİL SERVİS HASTA DENEYİM ANKETİ</Form.Label>
                        </Row>
                        <Row>
                        <Row>
                    ...
                    <Row >
                        ...
                        <Col md >
                            <Row >
                            <Col md xs="auto" >
                                <Form.Label >Acile Başvuru Şekli : </Form.Label>
                            </Col>
                            <Col md xs="auto" className="my-1">
                                <Form.Check value="0" onChange={handleChange} inline name="rdbBasvuruSekli" label="Kendi İmkanları ile" id="rdbBasvuruSekli1" type="radio" />
                                <Form.Check value="1" onChange={handleChange} inline name="rdbBasvuruSekli" label="Ambulans ile" id="rdbBasvuruSekli2" type="radio" />
                            </Col>
                            </Row>
                        </Col>
                    </Row>  
                    ...
                    <Form.Group className="mt-5 mb-3">
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>3.Acil Servis içinde ulaşmam gereken birimlere kolaylıkla ulaşabildim .</Form.Label>
                                </Row>
                            
                                <Col md xs="auto" style={{fontSize:"17px"}}>
                                <Form.Check value="0" onChange={handleChange} label="Tamamen Katılıyorum" type="radio" inline name="rdbBirimlereUlasma" id="rdbBirimlereUlasma1"/>
                                <Form.Check value="1" onChange={handleChange} label="Katılıyorum" type="radio" inline name="rdbBirimlereUlasma" id="rdbBirimlereUlasma2"/>
                                <Form.Check value="2" onChange={handleChange} label="Kararsızım" type="radio" inline name="rdbBirimlereUlasma" id="rdbBirimlereUlasma3"/>
                                <Form.Check value="3" onChange={handleChange} label="Katılmıyorum" type="radio" inline name="rdbBirimlereUlasma" id="rdbBirimlereUlasma4"/>
                                <Form.Check value="4" onChange={handleChange} label="Kesinlikle Katılmıyorum" type="radio" inline name="rdbBirimlereUlasma" id="rdbBirimlereUlasma5"/>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>5.Bekleme Alanının fiziki koşulları yeterliydi .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>6.Muayene olmak için beklediğim süre uygundu .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>7.Muayene olduğum alanın fiziki koşulları yeterliydi .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>8.Doktorumun bana ayırdığı süre yeterliydi .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                    <Form.Label>9.Muayene ve Tetkikler sırasında kişisel mahremiyetime özen gösterildi .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>13.İhtiyaç halinde gerekli sağlık personeline kolaylıkla ulaştım .</Form.Label>
                                </Row>
                            
                                <Col md xs="auto" style={{fontSize:"17px"}}>
                                <Form.Check value="0" onChange={handleChange} label="Tamamen Katılıyorum" type="radio" inline name="rdbPersoneleKolayUlasim" id="rdbPersoneleKolayUlasim1"/>
                                <Form.Check value="1" onChange={handleChange} label="Katılıyorum" type="radio" inline name="rdbPersoneleKolayUlasim" id="rdbPersoneleKolayUlasim2"/>
                                <Form.Check value="2" onChange={handleChange} label="Kararsızım" type="radio" inline name="rdbPersoneleKolayUlasim" id="rdbPersoneleKolayUlasim3"/>
                                <Form.Check value="3" onChange={handleChange} label="Katılmıyorum" type="radio" inline name="rdbPersoneleKolayUlasim" id="rdbPersoneleKolayUlasim4"/>
                                <Form.Check value="4" onChange={handleChange} label="Kesinlikle Katılmıyorum" type="radio" inline name="rdbPersoneleKolayUlasim" id="rdbPersoneleKolayUlasim5"/>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>14.Acil servis personeli nezaket kurallarına uygun davrandı .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>15.Acil servis genel olarak temizdi .</Form.Label>
                                </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>16.Acil servisin sunmuş olduğu hizmetler beklentilerimi karşıladı .</Form.Label>
                                </Row>
                            
                                <Col md xs="auto" style={{fontSize:"17px"}}>
                                <Form.Check value="0" onChange={handleChange} label="Tamamen Katılıyorum" type="radio" inline name="rdbSunmusOlduguHimetler" id="rdbSunmusOlduguHimetler1"/>
                                <Form.Check value="1" onChange={handleChange} label="Katılıyorum" type="radio" inline name="rdbSunmusOlduguHimetler" id="rdbSunmusOlduguHimetler2"/>
                                <Form.Check value="2" onChange={handleChange} label="Kararsızım" type="radio" inline name="rdbSunmusOlduguHimetler" id="rdbSunmusOlduguHimetler3"/>
                                <Form.Check value="3" onChange={handleChange} label="Katılmıyorum" type="radio" inline name="rdbSunmusOlduguHimetler" id="rdbSunmusOlduguHimetler4"/>
                                <Form.Check value="4" onChange={handleChange} label="Kesinlikle Katılmıyorum" type="radio" inline name="rdbSunmusOlduguHimetler" id="rdbSunmusOlduguHimetler5"/>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>17.Acil servisten ayrılırken taburculuk sonrası süreç ile ilgili yeterli bilgilendirme yapıldı .</Form.Label>
                                </Row>
                            
                                <Col md xs="auto" style={{fontSize:"17px"}}>
                                <Form.Check value="0" onChange={handleChange} label="Tamamen Katılıyorum" type="radio" inline name="rdbYeterliBilgi" id="rdbYeterliBilgi1"/>
                                <Form.Check value="1" onChange={handleChange} label="Katılıyorum" type="radio" inline name="rdbYeterliBilgi" id="rdbYeterliBilgi2"/>
                                <Form.Check value="2" onChange={handleChange} label="Kararsızım" type="radio" inline name="rdbYeterliBilgi" id="rdbYeterliBilgi3"/>
                                <Form.Check value="3" onChange={handleChange} label="Katılmıyorum" type="radio" inline name="rdbYeterliBilgi" id="rdbYeterliBilgi4"/>
                                <Form.Check value="4" onChange={handleChange} label="Kesinlikle Katılmıyorum" type="radio" inline name="rdbYeterliBilgi" id="rdbYeterliBilgi5"/>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Row md xs="auto" style={{fontSize:"24px"}}>
                                <Form.Label>18.Bu acil servisi aileme ve arkadaşlarıma tavsiye ederim .</Form.Label>
                                </Row>
